# **<span style="color:#6A1B9A;">Audiobookshelf Installation via Proxmox VE Helper Scripts</span>**
...
```
    * This will start an interactive wizard to deploy <span style="color:#6A1B9A;">Audiobookshelf</span>.
