...
Your Snipe-IT instance should now be running. Refer to the [Snipe-IT Official documentation](https://snipe-it.readme.io/docs/installation) for advanced configuration and troubleshooting.