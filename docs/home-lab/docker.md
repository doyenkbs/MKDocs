...
Below are the installation steps for <span style="color:#009688;">Docker</span> and <span style="color:#009688;">Docker Compose</span> on Debian and Ubuntu.
...
These **optional** steps help configure your Linux system for easier <span style="color:#009688;">Docker</span> usage.

### **Run Docker Without `sudo`**

By default, <span style="color:#009688;">Docker</span> requires `sudo` because the <span style="color:#009688;">Docker</span> daemon runs as `root` and listens on a Unix socket owned by `root`.

To allow your user to run <span style="color:#009688;">Docker</span> without `sudo`:
