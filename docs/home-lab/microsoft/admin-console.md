---
title: Install SCCM Admin Console on a Workstation
tags:
  - SCCM
  ...
  - Systems Management
  - Admin Console
summary: This guide explains how to install the SCCM (Configuration Manager) Admin Console on an administrator workstation.
---
